...
var lengthabove = stringValue.split('.')[0].length 
	var price = ((parseFloat(mBal) / 600000))
...
console.log(price);
	...
	price = price / Math.pow(10, length)
		...
		var price = Math.floor(((parseFloat(mBal) / 600000)))
...
var length = stringValue.split('.')[1].length
var lengthabove = stringValue.split('.')[0].length 
	var price = -1*((parseFloat(mBal) / 600000)/2)
	console.log('length: ' + length);
	console.log('lengthabove: ' + lengthabove);
if (length >= lengthabove){
	price = price * Math.pow(10, length)
...
console.log(price);
	...
	price = price / Math.pow(10, length)
		...
		var price = Math.floor(-1*((parseFloat(mBal) / 600000)/2))
...
var qty = (parseFloat(mBal) / 600000);
setTimeout(function(){
var verb = 'POST',
  path = '/api/v1/position/leverage',
  expires = new Date().getTime() + (60 * 1000), // 1 min in the future
...
var length = stringValue.split('.')[1].length
var lengthabove = stringValue.split('.')[0].length 
	var price = (-1 * (parseFloat(mBal) / 600000))
	console.log('length: ' + length);
	console.log('lengthabove: ' + lengthabove);
if (length >= lengthabove){
	price = price * Math.pow(10, length)
...
console.log(price);
	...
	price = price / Math.pow(10, length)
		...
		var price = Math.floor((-1 * (parseFloat(mBal) / 600000)))
...
var length = stringValue.split('.')[1].length
var lengthabove = stringValue.split('.')[0].length 
	var price = ((parseFloat(mBal) / 600000)/2)
	console.log('length: ' + length);
	console.log('lengthabove: ' + lengthabove);
if (length >= lengthabove){
	price = price * Math.pow(10, length)
...
console.log(price);
	...
	price = price / Math.pow(10, length)
		...
		var price = Math.floor(((parseFloat(mBal) / 600000)/2))
